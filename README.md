...
一个面向科目一、科目四学习视频打卡的 macOS 小工具：监测可见的 iPhone 镜像画面，在出现明确的人脸验证提示时发送原生 macOS 通知，提醒本人回到手机前完成认证。也适用于其他要求本人完成学习或观看的视频打卡场景。

## 适用场景

- 科目一、科目四学习视频打卡时出现的人脸验证提示。
- 其他学习平台或视频打卡流程中需要本人处理的人脸验证提示。
- 本工具只负责检测与提醒，不会代替、绕过或伪造认证。
